...
def regconize():
	...
	while True:
		...
		cv2.putText(blackboard, f"Du doan: {text}", (30, 100), cv2.FONT_HERSHEY_TRIPLEX, 1, (255, 255, 0))
		cv2.putText(blackboard, "Xac suat: {:.2f}%".format(prediction_probability * 100), (30, 170), cv2.FONT_HERSHEY_TRIPLEX, 1, (255, 255, 0))
